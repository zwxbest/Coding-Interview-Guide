package com.tuowazi.base.graph.better_lazy_prim;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String filename1 = "graph/betterLazyPrim1.txt";
        int V1 = 8;

        String filename2 = "graph/betterLazyPrim2.txt";
        int V2 = 250;

        String filename3 = "graph/betterLazyPrim3.txt";
        int V3 = 1000;

        String filename4 = "graph/betterLazyPrim4.txt";
        int V4 = 10000;
