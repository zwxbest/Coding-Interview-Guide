package com.tuowazi.base.graph.kruskal;

import com.tuowazi.base.graph.better_lazy_prim.PrimMST;
import com.tuowazi.base.graph.lazy_prim.LazyPrimMST;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String filename1 = "graph/kruskal1.txt";
        int V1 = 8;

        String filename2 = "graph/kruskal2.txt";
        int V2 = 250;

        String filename3 = "graph/kruskal3.txt";
        int V3 = 1000;

        String filename4 = "graph/kruskal4.txt";
        int V4 = 10000;
